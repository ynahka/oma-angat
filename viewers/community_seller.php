...
<body>
    ...
    <section class="inner-section blog-grid">
        <div class="container">
            <div class="col-lg-12">
                <?php if (empty($_SESSION['user_id']) || $_SESSION['usertype'] !== 'SELLER') { ?>
                <?php } else { ?>
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <div class="blog-card">
                                <div class="blog-media">
                                    <a class="blog-img"
                                        href="blog-details_seller.php?post_id=<?php echo $row['post_id']; ?>">

                                        <img src="../OmaangatImages/posts/<?php echo htmlentities($row['imahe']); ?>"
                                            alt="blog" style="width: 300px; height: 230px;">
                                    </a>
                                </div>
                                <div class="blog-content">
                                    ...
                                    <h4 class="blog-title">
                                        <a
                                            href="blog-details_seller.php?post_id=<?php echo $row['post_id']; ?>"><?php echo htmlentities($row['posttitle']); ?></a>
                                    </h4>
                                    <p class="blog-desc">
...
function uploadpost(genid) {
    ...
    $.ajax({
        ...
        processData: false,
        success: function(data) {
            window.location = "community_seller.php";
        }
    });
}
</script>