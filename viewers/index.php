                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-content">
                            ...
                            <p>Shop directly from farmers!<br>Get healthy and locally grown produce right at your doorstep.
                            </p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-content">
                            ...
                            <p>Join and watch your fields grow. <br>We ensure your fair compensation for your dedication.</p>
                            <div class="banner-btn-1">
    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $Pitem = [
                ...
                "url" => "seller-shop.php", // You may want to customize this based on your requirements
                "title" => $row['username'],
