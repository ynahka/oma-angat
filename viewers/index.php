                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class=" intro-wrap">
                        <div class="intro-content">
                            <h3>Farm To Table Quality</h3>
                            <p>Each produce piece is top quality, ensuring the tastiest and healtiest experience everytime.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="intro-wrap">
                        ...
                        <div class="intro-content">
                            <h3>Locally Grown</h3>
                            <p>Choose our locally grown fruits and veggies to support local farmers and reduce your carbon footprint.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="intro-wrap">
                        <div class="intro-content">
                            <h3>Colorful Variety</h3>
                            <p>Savor a flavor rainbow! Juicy fruits, crunchy greeen - our selection pleases all tastes. Delight in healthy bites.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="intro-wrap">
                        <div class="intro-content">
                            ...
                            <p>Choose a healthier lifestyle with our organic produce -- free frfom pesticides and chemicals.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 order-0 order-lg-1 order-xl-1">
                    <div class="home-grid-slider slider-arrow slider-dots">
                        ...
                        <iframe width="1263" height="400" src="https://www.youtube.com/embed/owXzG8gFfXI" title="Support Family Farming - Help Local Farmers, Achieve Zero Hunger [Advocacy Video]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        <iframe width="1263" height="400" src="https://www.youtube.com/embed/jzx3M7G9bns" title="Support Filipino Farmers" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
            ...
            <ul class="suggest-slider slider-arrow">
                <?php foreach ($Pitems as $Pitem) : ?>
                    <li>
                        ...
                        <div class="suggest-info" style="text-align: center; font-weight:500; ">
                            <p><?php echo $Pitem['description'] ?></p>
                        </div>
                    </li>
                <?php endforeach; ?>
