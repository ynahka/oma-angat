    ...
    if ($numrows == TRUE) {
      while ($row = mysqli_fetch_array($res)) {
        ...
        echo "</a>
	                                ...
	                                <div class='product_content grid_content' style='  color: #39404a !important;'>
        ...
        echo "</ul>
		                                    ...
		                                    <h4 class='product_name' style='color: #39404a !important;'><a href='javascript:void(0)' title='$row[1]' onclick='openproductdetails(\"" . $row[0] . "\")'>" . $row[1] . "</a></h4>
		                                    <div class='price_box'>
...
?> <option value="">- Select Category -</option> <?php
	                        ...
	                        <div class='comment_text'>
	                            <div class='reviews_meta'>
	                                ...
	                                <span>" . $row3[0] . "</span>
                                                  ...
                                                  // SELLER
                                                  $getseller = mysqli_fetch_array(mysqli_query($connection, "SELECT user_id, CASE WHEN middlename = '' OR middlename IS NULL THEN CONCAT(lastname, ', ', firstname) ELSE CONCAT(lastname, ', ', firstname, ' ', LEFT(middlename, '1'), '.') END FROM users_table WHERE user_id = '" . $productdet[7] . "';"));
		                            ...
		                            <div class='reviews_meta'>
		                                ...
		                                <span>" . $row3[0] . "</span>
                                                ...
                                                case 'sendchattoseller':
                                                  ...
                                                  $productID = mysqli_real_escape_string($connection, $_POST['productIDmessage']);

                                                  $sendchattoseller = mysqli_query($connection, "INSERT INTO chats (user_id, message, sendto, productID) VALUES ('$user_id', '$message', '$sendto', '$productID')");
                                                ...
                                                case 'updateaddressnowna':
                                                  $user_id = $_SESSION['user_id'];
                                                  $address = $_POST['textregfulladdress'];
                                                  $housenum = $_POST['textreghousenum'];
                                                  $street = $_POST['textregstreet'];
                                                  $subdivision = $_POST['textregsubdi'];
                                                  $barangay = $_POST['textregbarangay'];
                                                  $city = $_POST['textregcity'];
                                                  $zipnum = $_POST['textregpostalcode'];
                                                  $province = $_POST['textregprovince'];
                                                  $latitude = $_POST['textreglat'];
                                                  $longitude = $_POST['textreglong'];

                                                  $updateaddressnowna = mysqli_query($connection, "UPDATE user_details SET
        address = '$address',
        housenum = '$housenum',
        street = '$street',
        ...
        WHERE user_id = '$user_id';");
                                                  ...
                                                  if ($updateaddressnowna) {
                                                    // Query executed successfully
                                                    echo json_encode(['success' => true, 'message' => 'Address successfully updated!']);
                                                  } else {
                                                    // Query failed
                                                    echo json_encode(['success' => false, 'message' => 'Error updating address: ' . mysqli_error($connection)]);
                                                  }
