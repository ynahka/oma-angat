                                                        ...
                                                        <ul>
                                                            <li><a href="javascript:void(0)"
                                                                    onclick="fncselectrating(1)"><i
                                                                        class="fa fa-star wawa starhover"></i></a>
                                                            </li>
                                                            <li><a href="javascript:void(0)"
                    ...
                    <div class="container">
                        ...
                        <div class="coupon_area" style="margin-bottom: 20px;">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="coupon_code left">
                                        <h3 style="margin-bottom: 0rem; background-color: #4c644b;">Payment Method
                                        </h3>
                                                    ...
                                                    <div class="paymentmethcash hoverpaymentmeth marginebottomforpaymeth"
                                                        ...
                                                        <div class="services_item" style="margin-bottom: 0px;">
                                                            ...
                                                            <div class="services_desc">
                                                                <h4 style="margin-bottom: 0rem;">CASH ON DELIVERY
                                                                </h4>
                        ...
                        <div class="coupon_area" style="margin-bottom: 20px;">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="coupon_code left">
                                        <h3 style="margin-bottom: 0rem; background-color: #4c644b;">Order Summary
                                        </h3>
                                        <div class="coupon_inner" style="padding: 10px 10px 10px;">
                        ...
                        <div class="cart_submit" style="padding: 0px;">
                            <button onclick="btnplaceorder()" style="background-color: #4c644b;">place
                                order</button>
                        </div>
