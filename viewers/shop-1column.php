...
<body>
                                ...
                                <a href="#" class="author-image">
                                    ...
                                    <div class="author-info">
                                        ...
                                        <ul class="author-meta">
                                            <li>
                                                <a onclick="opensellerchatnow(('<?= $shopseller_id ?>'));" class=" fas fa-comments">
                                                </a>Message
                                                Farmer
                                </a></li>
                                </ul>
            ...
            <div class="col-lg-3">
                ...
                <div class="shop-widget-promo">
                    ...
                    <div class="offer-div">
                        ...
                        <a class="blog-btn" href="javascript:void(0)" onclick="opensellerchatnow('<?= $shopseller_id ?>');">
    ...
    <div class="modal fade" id="modal_chatseller" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="contact_message form">
                                    <p style="margin-bottom: 10px;">
                                        ...
                                        <textarea id="txtSendMessage" style="height: 150px;margin-bottom: 0px;"></textarea>
                                    </p>
                                </div>
                            </div>
                        </div>
