...
<body>
    ...
    <div class="modal fade" id="modal_productdet" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background-color: #cfe2ce">
                ...
                <button class="modal-close icofont-close" data-bs-dismiss="modal" onclick="clearmdl_productdet();"></button>
    ...
    <div class="modal fade" id="modal_productbuynow" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <button class="modal-close icofont-close" data-bs-dismiss="modal" onclick="clearbuynowmodal();"></button>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="coupon_code left">
                                        ...
                                        <div class=" coupon_inner" style="padding: 10px 20px 10px;">
                                            ...
                                            <span></span><br>
                                            <button class="btn btn-primary reqresinfo" id="btnregfulladdress" style="cursor:pointer;" onclick="openmdladdress();">Edit
                                                Address</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="modal_address" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border: 2px solid #82a131;background-color: #cfe2ce; border-radius: 10px">
                <!-- <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" onclick="" style="left: 92%;">
                    <span aria-hidden="true"><i class="icon-x"></i></span>
                ...
                <div class="modal_body" style="padding: 29px 6px 20px;">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea class="form-control" name="txtregfulladdress" id="txtregfulladdress" rows="2" readonly style="cursor:pointer;" onclick="openmdlsearchaddress();"></textarea><br>
                            </div>
                        </div>
                        ...
                        <span></span><br>
                        <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light" onclick="updateaddressnowna();" style="padding: 10px 10px; font-weight: 500; background-color: #4C644B; border: #4C644B 1px solid">Update
                            Address</button>
