...
switch ($_POST['form']) {
	...
	case 'sendchattoseller':
		$sendchattoseller = mysqli_query($connection, "INSERT INTO chats SET user_id = '" . $_SESSION['user_id'] . "', message = '" . $_POST['textsendchatmessage'] . "', sendto = '" . $_POST['textmdlprodseller_id'] . "';");
		break;
