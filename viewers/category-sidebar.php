...
<aside class="nav-sidebar">
    ...
    <div class="nav-content">
        ...
        <ul class="nav-list">
            ...
            <li>
                <a class="nav-link" href="reserve_products.php"><i class="fa-solid fa-bullhorn"></i>Coming Soon</a>
            </li>
            <li>
            ...
            <li>
                <a class="nav-link" href="my_reservation.php"><i class="fas fa-address-book"></i>My Reservations</a>
            </li>
