...
if (empty($_SESSION["Email_Session"])) {
    header('location:../buyeraccount/index.php');
} else {
?>
                    ...
                    <div class="banner-category">
                        ...
                        <ul class="banner-category-list">
                            <?php
                                ...
                                // Your SQL query to retrieve all records
                                ...
                                if ($result) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo '<li class="banner-category-item">';
                                        echo '<a href="#">';
                                        echo '<i class="flaticon-vegetable"></i>';
                                        echo '<span>' . $row['ctgry_name'] . '</span>';
                                        echo '</a>';

                                        // Display the subcategories if needed
                                        // (You may adjust this part based on your actual data structure)
                                        echo '<div class="banner-category-dropdown">';
                                        echo '<h5>' . $row['ctgry_name'] . ' item</h5>';
                                        echo '<div class="banner-sub-category">';

                                        // Fetch and display subcategories (assuming you have a related table for subcategories)
                                        $subcategories_sql = "SELECT * FROM Subcategories WHERE category_id = " . $row['category_id'];
                                        $subcategories_result = mysqli_query($conx, $subcategories_sql);

                                        while ($subrow = mysqli_fetch_assoc($subcategories_result)) {
                                            echo '<ul>';
                                            echo '<li><a href="#">' . $subrow['subcategory_name'] . '</a></li>';
                                            // Add more subcategory details as needed
                                            echo '</ul>';
                                        }
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6 col-lg-6">
                                            <div class="banner-content">
                                                <h2>we delivered organic foods item within 24 hours.</h2>
