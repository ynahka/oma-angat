            ...
            <ul class="navbar-nav mr-auto mt-md-0 ">
                ...
                <li class="nav-item dropdown kailangan2" style="padding-left:5px;">
                    <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href=""
                        ...
                        <h5 class="text-white" style="margin-bottom:0px;"><img src="assets/images/single-logo.png alt="
                                homepage" class="dark-logo imagetopbar" style="width: 200px;" /></h5>
                    </a>
                </li>
            ...
            <ul class="navbar-nav my-lg-0">
                <li class="nav-item dropdown">
                    <a class="nav-link text-muted waves-effect waves-dark" href="#"
                        style="font-weight: 400; font-size: 16px; padding-right: 1px;"><span
                            id=""><b><?php echo $_SESSION['firstname']?></b></span></a>
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                        style="line-height: 0px !important; padding-left: 2px; padding-right: 5px;"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn waves-effect waves-light btn-secondary"
                            style="background-color: #79a206 !important; border: 1px solid #79a206 !important;"
