                    ...
                    <div class="chat-left-aside">
                        ...
                        <div class="chat-left-inner">
                            <div class="form-material" style="margin-top:10px;">
                                <input class="form-control p-3" type="text" placeholder="Search Conversation"
                        ...
                        <div class="card-body" style="border-top: 0.5px solid #fff ">
                            <div class="row">
                                <div class="input-group">
                                    ...
                                    <input type="file" name="imageAttachment" id="imageAttachment" accept="image/*"
                                        style="display: none;">
