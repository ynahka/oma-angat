    ...
    <div class="modal-dialog modal-md"style="max-width: 530px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control clearinfo reqresinfo" id="txtadduserFname" style="font-size: .9rem;">
                    </div>

                    <div class="col-md-4 mb-2 modalpaddingnew">
                        <span style="font-weight:400">Middlename</span>
                        <input type="text" class="form-control clearinfo" id="txtadduserMname" style="font-size: .9rem;">
                    </div>

                    <div class="col-md-4 mb-2 modalpaddingnew">
                        <span style="font-weight:400">Lastname</span>
                        <input type="text" class="form-control clearinfo reqresinfo" id="txtadduserLname" style="font-size: .9rem;">
                    </div>

                    <div class="col-md-6 mb-2">
                        <span style="font-weight:400">Contact Number</span>
                        <input type="text" class="form-control clearinfo contactnum " id="txtadduserContact" style="font-size: .9rem;">
                    </div>

                    <div class="col-md-6 mb-2 modalpaddingnew">
                        <span style="font-weight:400">Email Address</span>
                        <input type="text" class="form-control clearinfo reqresinfo" id="txtadduserEmail" style="font-size: .9rem;">
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" class="form-control clearinfo reqresinfo" id="txtadduserUsername" style="font-size: .9rem;">
                    </div>
            ...
            <div class="modal-footer mt-4" style="padding: 10px 15px;">
                <div class="row">
                    <div class="col-md-12">
                        <button type="button" class="btn waves-effect waves-light btn-secondary float-right buttonproduct btnuseraccSAVE" onclick="adduseracc();" style="background-color: #79a206 !important; border: 1px solid #79a206 !important;">Save Customer</button>

                        <button type="button" class="btn waves-effect waves-light btn-secondary float-right buttonproduct btnuseraccUPDATE" onclick="adduseracc();" style="background-color: #79a206 !important; border: 1px solid #79a206 !important; display: none;"><i class="fas fa-save"></i> Update</button>
                    </div> 
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div style="display: flex;justify-content: space-between !important;">
                            <h4 class="headerfontfont2" style="color: #2c2b2e;font-weight: 500;">Customer Information</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="clearuseracc()" style="padding: 1rem 1rem;margin: -1.6rem -1rem -1rem auto;">×</button>
                        </div>
                    </div>
                </div>
