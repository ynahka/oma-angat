        ...
        if ($query) {
            ...
            try {
                ...
                $mail->Body    = '<p>We received a request to reset your password on Oma-Angat Agri-Market. If you did not initiate this request, please ignore this email.</p>
                                ...
                                <p><a href="http://localhost/oma-angat/farmeraccount/change-Password.php?Reset=' . $CodeReset . '">"http://localhost/oma-angat/farmeraccount/change-Password.php?Reset=' . $CodeReset . '"</a></p>
