...
switch ($_POST['form']) {
	case 'registeruseraccount':
		...
		$mail->Body    = '<h3>Dear ' . $_POST['textregusername'] . ',</h3>
			...
			<a href="http://oma-angat.online/buyer/login.php?code=' . $code . '">"http://oma-angat.online/buyer/login.php?code=' . $code . '"</a>
			...
			<br>Thank you and welcome to Oma-Angat Agri-Market, Add to cart and buy now!</p>
			<p></p>
			<p></p>
			<p>Best regards,</p>
