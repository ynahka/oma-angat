            ...
            <div class="card">
                <header class="auth-header">
                    <a href="#" class="text-center db" style="padding-top: 5px;padding-bottom: 5px;"><img
                            src="../admin/assets/images/single-logo.png" alt="Home" width="40%" height="auto"
                            title="Homepage" />
                    </a>
                </header>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-11" style="flex: 0 0 98.2%; max-width: 98.2%;">
                                <input type="email" class="form-control underlined"
                                    style="border-bottom: 0.5px solid #4C644B !important;" name="txtusername"
                                    id="txtusername" placeholder="" required style="height: 40px; background: #CFE2CE;">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-11" style="padding-right: 0px; flex: 0 0 95%; max-width: 95%;">
                                    <input type="password" class="form-control underlined"
                                        style="border-bottom: 0.5px solid #4C644B !important;" name="txtpassword"
                                        id="txtpassword" placeholder="" required
                                        style=" height: 40px; background: #CFE2CE;">
                                </div>
                                <div class="col-md-1"
                                    ...
                                    <i class="fa fa-eye-slash"
                                        ...
                                        id="logineye" onclick=" fncloginpassattribHash()"></i>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mt-4">
                            <div class="col-xs-12">
                                <a href="../seller/forgot_password.php"
                                    style="font-size: 16px; margin-bottom: 14px; display:block;">Forgot Password?</a>
                                <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light"
                                    onclick="loginuser();"
                                    style="padding: 10px 10px; font-weight: 500; background-color: #4C644B; border: #4C644B 1px solid">LogIn</button>
