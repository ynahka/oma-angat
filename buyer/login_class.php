<?php
	...
	switch ($_POST['form']) {
        ...
        case 'loginuser':
			$sqllogin = "SELECT id, user_id, username, firstname, lastname, usertype, status FROM users_table WHERE username = '".$_POST['txtusername']."' AND password = '". $_POST['txtpassword'] ."' AND usertype = 'CUSTOMER' ";
