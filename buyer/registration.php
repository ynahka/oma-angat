            ...
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label class="mt-2" for="txtregFname"
                                style="margin-bottom: 0px; font-weight: 500;">Firstname</label>
                            <div class="row">
                            ...
                            <label class="mt-2" for="txtregcontactphone"
                                style="margin-bottom: 0px; font-weight: 500;">Contact Number</label>
                            <div class="row">
                                <div class="col-md-12 contact_message form">
                            ...
                            <div class="row">
                                <div class="col-md-12 contact_message form">
                                    <div class="contact_textarea">
                                        <textarea class="form-control2 reqresinfo" name="txtregfulladdress"
                    ...
                    <div class="form-group text-center mt-4">
                        <div class="col-xs-12 contact_message form">
                            <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light"
                                ...
                                style="padding: 10px 10px; font-weight: 500; background-color: #4C644B; border: #4C644B 1px solid">
                                Submit</button>
                        </div>
            ...
            <div class="modal-content" style="border-radius: 10px;">
                ...
                <div class="modal_body">
                    <div class="container">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="contact_message form">
                                    <p>
                                        ...
                                        <select class="reqresinfo2" type="text" id="txtregpostalcode2" required
                                            size="1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label class="" for="txtreghousenum2"
                                    style="margin-bottom: 0px; font-weight: 500;">House
                                    Number</label>
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="txtreghousenum2"
                                            id="txtreghousenum2" style="height: 40px;">
                                    </div>
                                </div>

                                <label class="mt-2" for="txtregstreet2"
                                    style="margin-bottom: 0px; font-weight: 500;">Street
                                    Name</label>
                                <div class="row">
                                    <div class="col-md-12">
