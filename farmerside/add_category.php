...
if (isset($_POST['submit'])) {
    if (empty($_POST['ctgry_name'])) {
        ...
        $check_cat = mysqli_query($conx, "SELECT ctgry_name FROM productcategory where ctgry_name = '" . $_POST['ctgry_name'] . "' ");
        ...
        if (mysqli_num_rows($check_cat) > 0) {
            ...
            $mql = "INSERT INTO productcategory (ctgry_name) VALUES('" . $_POST['ctgry_name'] . "')";
            mysqli_query($conx, $mql);
...
<head>
    ...
    <title>Oma-Angat|Adding Categories</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header" style="background: rgb(0, 188, 126);">
                                    <h4 class="m-b-0 text-white">Add Market Category</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="row p-t-20">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="ctgry_name" class="form-control" placeholder="Category Name">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql = "SELECT * FROM productcategory order by category_id desc";
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo ' <tr><td>' . $rows['category_id'] . '</td>
																								...
																								<td>' . $rows['date_created'] . '</td>
																									 ...
																									 <a href="update_category.php?cat_upd=' . $rows['category_id'] . '" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5" style="background: rgb(0, 188, 126);"><i class="ti-settings"></i></a>
																									</td></tr>';
                                                }
                                            }
