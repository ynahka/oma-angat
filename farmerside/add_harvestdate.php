    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    ...
                    <a href="add_category.php" class="navbar-brand"><img src="images/web-logo.png" style="display:inline; width: 30%;"alt="logo"></a>
                    </a>
                </div>
                <!-- End Logo -->
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Harvesting Calendar</h3> </div>
                            ...
                            <div class="card-body">
                                <form action='' method='post' >
                                    ...
                                    <div class="row p-t-20">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="HarvestDate" class="form-control" placeholder="Harvest starts from">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="row p-t-20">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="harvestEnd" class="form-control" placeholder="Harvest ends on">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="form-actions">
                                        <input type="submit" name="submit_harvest" class="btn btn-success" value="Save" style="background: rgb(0, 188, 126);"> 
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['harvest_id'].'</td>
                                                                                                ...
                                                                                                <td>'.$rows['addedat'].'</td>
																									 ...
																									 <td><a href="delete_category.php?cat_del='.$rows['harvest_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_category.php?cat_upd='.$rows['harvest_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5" style="background: rgb(0, 188, 126);"><i class="ti-settings"></i></a>
																									</td></tr>';
