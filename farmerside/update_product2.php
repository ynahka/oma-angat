...
if (isset($_POST['submit']))           //if upload btn is pressed
{
    ...
    if (empty($_POST['p_name']) || empty($_POST['about']) || $_POST['Price'] == '' || $_POST['QuantityAvlbl'] == '' || $_POST['QuantiSold'] == '' || $_POST['ctgry_name'] == '') {
        ...
        $product = "Product_img/" . basename($fnew);                      // the path to store the upload image
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "update products set category_id='$_POST[ctgry_name]',productName='$_POST[p_name]',description='$_POST[about]',Price='$_POST[Price]',QuantityAvlbl='$_POST[QuantityAvlbl]',QuantiSold='$_POST[QuantiSold]',img='$fnew' where product_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
                mysqli_query($conx, $sql);
                move_uploaded_file($temp, $product);
                $success =     '<div class="alert alert-success alert-dismissible fade show">
						            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
									<strong>Record</strong>Products Updated Successfully.</div>';
            }
        }
    }
}
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="p_name" value="<?php echo $roww['ProductName']; ?>" class="form-control" placeholder="Morzirella">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="res_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                    ...
                                                    <?php $ssql = "select * from market";
                                                    $res = mysqli_query($conx, $ssql);
