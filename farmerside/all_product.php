            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="index.php" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">HOME</span></a></li>
                            ...
                            -body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM products WHERE store_id IN (SELECT store_id FROM store s
                                            INNER JOIN farmer f ON s.farmer_id = f.farmer_id
                                            INNER JOIN useraccount u ON f.user_id = u.user_id
                                            WHERE u.email = '{$_SESSION['Email_Session']}') ORDER BY product_id DESC";
                                            $query = mysqli_query($conx, $sql);

                                            if (!mysqli_num_rows($query) > 0) {
                                                echo '<tr><td colspan="11"><center>No Product-Data!</center></td></tr>';
                                            } else {
                                                ...
                                                <td>
                                                    <a href="delete_product.php?menu_del=' . $rows['product_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
