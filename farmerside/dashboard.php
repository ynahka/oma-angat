            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="profile.php" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Profile</span></a>
                        </li>
        ...
        <div class="page-wrapper" style="height:5s00px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text" style="color: #173a5f;">Dashboard</h3> </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2 style="color: white; font-weight: 700" ><?php $sql="select * from Store";
												$result=mysqli_query($conx,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0" style="color: white;">Market</p>
                                </div>
                            </div>
                        </div>
                    </div>
					 ...
					 <div class="col-md-3">
                        <div class="card p-30" style="background: rgb(0, 188, 126);">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 style="color: white; font-weight: 700"><?php $sql="select * from products";
												$result=mysqli_query($conx,$sql); 
													$rws=mysqli_num_rows($result);
													echo $rws;?></h2>
