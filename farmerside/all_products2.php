																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$fetch['title'].'</td>
																								...
																								<center><img src="Res_img/'.$rows['img'].'" class="img-responsive radius"  style="min-width:150px;min-height:100px;"/></center>
																									 ...
																									 <a href="update_product.php?menu_upd='.$rows['d_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5" style="background: rgb(0, 188, 126);"><i class="ti-settings" ></i></a>
																									</td></tr>';
