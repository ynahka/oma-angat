                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ProductName"
                                                    value="<?php echo $roww['ProductName']; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="QuantityAvlbl"
                                                    value="<?php echo $roww['QuantityAvlbl']; ?>" class="form-control"
                                                    placeholder="₱">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="QuantiSold"
                                                    value="<?php echo $roww['QuantiSold']; ?>" class="form-control"
                                                    placeholder="₱">
                                            </div>
                                        </div>
                                        <!--/span-->
                        ...
                        <div class="form-actions">
                            <input type="submit" name="update_product" class="btn btn-success" value="Save"
