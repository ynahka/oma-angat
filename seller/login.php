                    ...
                    <div class="form-horizontal form-material">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-11" style="flex: 0 0 98.2%; max-width: 98.2%;">
                                <input type="email" class="form-control underlined" name="txtusername" id="txtusername"
                                    placeholder="Enter your username" required style="height: 40px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-4">
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light"
                                    onclick="loginuser();"
                                    style="padding: 10px 10px; font-weight: 500; background-color: #79c78d; border: #79a206 1px solid">LogIn</button>
                                <span style="font-size: 16px; margin-top:14px; display:block;">Don't have an account
                                    yet?<a href="register.php" class="text-info"> Create an Account.</a></span>
                            </div>
                        </div>
                    </div>
                </div>
