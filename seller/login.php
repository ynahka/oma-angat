                ...
                <div class="card-body cardbodylogin" style="padding: 1.25rem 1.8rem;">
                    <div class="form-horizontal form-material">
                        ...
                        <div class="form-group mt-4">
                            <div class="col-xs-12">
                                <a href="forgot-password.php" style="font-size: 16px; margin-bottom: 14px; display:block;">Forgot Password?</a>
                                <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light" onclick="loginuser();" style="padding: 10px 10px; font-weight: 500; background-color: #79c78d; border: #79a206 1px solid">LogIn</button>
                                <span style="font-size: 16px; margin-top:14px; display:block;">Don't have an account yet?<a href="register.php" class="text-info"> Create an Account.</a></span>
                            </div>
                        </div>
                    </div>
                </div>
