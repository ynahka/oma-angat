                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div style="display: flex;justify-content: space-between !important;">
                            ...
                            <button type="button" class="close closebtn" data-dismiss="modal" aria-hidden="true" onclick="clearuseracc()" style="padding: 1rem 1rem;margin: -1.6rem -1rem -1rem auto;">×</button>
                        </div>
                    </div>
                </div>
<!-- <option value="PENDING">Pending
<option value="TOPAY">To Pay
<option value="TOSHIP">To Ship
<option value="TODELIVER">For Delivery
                ...
                <div class="row">   
                    ...
                    <div class="col-md-5">
                          ...
                          <div class="order-track">
                            <div class="order-track-step">
                              ...
                              <div class="order-track-text">
                                <p class="order-track-text-stat order-track-text-statstatus order-track-text-stat1"></p>
                        ...
                        <div class="form-group">
                          <input class="form-control trackingnumber" placeholder="Tracking Number" onkeyup="inputrequired()">
                        </div>
                        </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <button type='button' class='btn waves-effect waves-light btn-dark float-right readytodeliver' disabled>READY TO DELIVER</button>
                        <div id="dsplybuttonfooter" class="dsplybuttonfooter"></div>
                    </div>
                </div>
            </div>
