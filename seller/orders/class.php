<?php
	...
	switch ($_POST['form']) {
		...
		case 'fncdsplyorderinfo':
            ...
            $customerdetails = mysqli_fetch_array(mysqli_query($connection, "SELECT CASE WHEN a.middlename = '' OR a.middlename IS NULL THEN CONCAT(a.lastname, ', ', a.firstname) ELSE CONCAT(a.lastname, ', ', a.firstname, ' ', LEFT(a.middlename, '1'), '.') END, b.contactnum, b.address, b.latitude, b.longitude FROM users_table AS a LEFT JOIN w AS b ON a.user_id = b.user_id WHERE a.user_id = '" . $_POST['customer_id'] . "';"));
