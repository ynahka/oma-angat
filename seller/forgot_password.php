                    ...
                    <div class="form-horizontal form-material">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-11" style="flex: 0 0 98.2%; max-width: 98.2%;">
                                <input type="email" class="form-control underlined" name="txtemail" id="txtemail"
                        ...
                        <div class="form-group mt-4">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light"
                                    ...
                                    style="padding: 10px 10px; font-weight: 500; background-color: #79c78d; border: #79a206 1px solid">Submit</button>
                                <span style="font-size: 16px; margin-top:14px; display:block;">Remembered your
                                    password?<a href="login.php" class="text-info"> Log In.</a></span>
                            </div>
                        </div>
                    </div>
                </div>
