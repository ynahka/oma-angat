    ...
    $(function() {
        if (!!scheds) {
            Object.keys(scheds).map(k => {
                var row = scheds[k]
                events.push({ id: row.id, productname: row.productname, start: row.availat, end: row.availuntil });
            })
        }
        var date = new Date()
        var d = date.getDate(),
        ...
        calendar = new Calendar(document.getElementById('calendar'), {
            ...
            eventClick: function(info) {
                ...
                if (!!scheds[id]) {
                    _details.find('#productname').text(scheds[id].title)
        ...
        $('#edit').click(function() {
            ...
            if (!!scheds[id]) {
                ...
                _form.find('[name="productdesc"]').val(scheds[id].productdesc)
                _form.find('[name="availat"]').val(String(scheds[id].availat).replace(" ", "T"))
