                ...
                <div class="row mb-2">
                    <div class="col-md-5">
                        ...
                        <!-- <div class="row">
                            <div class="col-md-12 mb-2">
                                <button class="btn waves-effect waves-light btn-light" style="width:100%" onclick="fncappendprodimage();"><i class="fas fa-plus"></i>QR Code</button>
                            </div>
                        </div> -->
                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                <span style="font-weight:400">Gcash Name</span>
                                <input type="text" class="form-control clearinfo reqresinfo" id="txtaddbankholdername"
                                    style="font-size: .9rem;">
                            </div>
                            <div class="col-md-12 mb-2">
                                <span style="font-weight:400">Gcash Number</span>
                                <input type="text" class="form-control clearinfo reqresinfo" id="txtaddbanknumber"
                                    style="font-size: .9rem;">
                            </div>
