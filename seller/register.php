                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control reqresinfo" name="txtregFname"
                                        id="txtregFname" style="height: 40px;">
                                </div>
                            </div>

                            <label class="mt-2" for="txtregMname"
                                style="margin-bottom: 0px; font-weight: 500;">Middlename</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="txtregMname" id="txtregMname"
                                        style="height: 40px;">
                                </div>
                            </div>

                            <label class="mt-2" for="txtregLname"
                                style="margin-bottom: 0px; font-weight: 500;">Lastname</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control reqresinfo" name="txtregLname"
                                        id="txtregLname" style="height: 40px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control reqresinfo contactnum"
                                        name="txtregcontactphone" id="txtregcontactphone" style="height: 40px;">
                                </div>
                            </div>

                            <label class="mt-2" for="txtregemail"
                                style="margin-bottom: 0px; font-weight: 500;">Email</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control reqresinfo" name="txtregemail"
                                        id="txtregemail" style="height: 40px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea class="form-control reqresinfo" name="txtregfulladdress"
                                        id="txtregfulladdress" rows="2" readonly style="cursor:pointer;"
                            ...
                            <label class="" for="txtregusername"
                                style="margin-bottom: 0px; font-weight: 500;">Username</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control reqresinfo" name="txtregusername"
                                        id="txtregusername" style="height: 40px;">
                                </div>
                            </div>

                            <label class="mt-2" for="txtadduserconfirmpass"
                                style="margin-bottom: 0px; font-weight: 500;">Password</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group" style="margin-top: 0px;">
                                        <input type="Password" class="form-control reqresinfo"
                                            id="txtadduserconfirmpass" style="height: 40px;">
                                        <div class="input-group-prepend" style="cursor: pointer;"
                                            onclick="fncaddpassattribunHash2();" id="inputaddusereye2">
                                            <span class="input-group-text"><i class="fas fa-eye-slash"
                                                    id="addusereye2"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form method="post" action="#" enctype="multipart/form-data" id="frmUploadvalidPic">
                                        <div class="row">
                                            <div class="col-md-12" style="display: none;">
                                                <img src="assets/images/noimage5.png" class="img-thumbnail" width="200"
                                                    height="250" style="border: 2px solid #bdc3c7; margin-bottom: 10px;"
                                                    id="updatevalidImage"><br>
                                            </div>
                                            <div class="col-md-12">
                                                <input type="file" class="dropify clearinfo reqresinfo"
                                                    id="txtvalidImagefile" name="txtvalidImagefile"
                                                    onchange="fncShowvalidPic();" accept="image/*" data-height="300">
                            ...
                            <label style="margin-bottom: 0px; font-weight: 500;">Profile Image</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="post" action="#" enctype="multipart/form-data"
                                        id="frmUploadvalidPic2">
                                        <div class="row">
                                            <div class="col-md-12" style="display: none;">
                                                <img src="assets/images/noimage5.png" class="img-thumbnail" width="200"
                                                    height="250" style="border: 2px solid #bdc3c7; margin-bottom: 10px;"
                                                    id="updatevalidImage2"><br>
                                            </div>
                                            <div class="col-md-12">
                                                <input type="file" class="dropify clearinfo reqresinfo"
                                                    id="txtvalidImagefile2" name="txtvalidImagefile2"
                                                    onchange="fncShowvalidPic2();" accept="image/*" data-height="300">
                                                <input type="hidden" class="clearinfo" name="txtvalidimageID2"
                                                    id="txtvalidimageID2">
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div class="form-group text-center mt-4">
                        <div class="col-xs-12">
                            <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light"
                                onclick="registeruseraccount();"
                                style="padding: 10px 10px; font-weight: 500; background-color: #79c78d; border: #79a206 1px solid">Register</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button"
                                ...
                                style="background-color: #79a206 !important; border: 1px solid #79a206 !important;">Search</button>
                        </div>
                    </div>
                </div>
