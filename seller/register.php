        ...
        <div class="auth-container">
            <div class="card">
                <header class="auth-header">
                    <a href="#" class="text-center db" style="padding-top: 5px;padding-bottom: 5px;"><img
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="txtregemail" id="txtregemail"
                                            style="height: 40px;">
                                    </div>
                                </div>
                                        ...
                                        <form method="post" action="#" enctype="multipart/form-data"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="display: none;">
                                                    <img src="assets/images/noimage5.png" class="img-thumbnail"
                                    ...
                                    <div class="col-md-12">
                                        <form method="post" action="#" enctype="multipart/form-data"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="file" class="dropify clearinfo" id="txtvalidImagefile2"
                                                        name="txtvalidImagefile2" onchange="fncShowvalidPic2();"
                                                        accept="image/*" data-height="300">
                        ...
                        <div class="form-group text-center mt-4">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-md btn-block text-uppercase waves-effect waves-light"
                                    ...
                                    style="padding: 10px 10px; font-weight: 500; background-color: #4C644B; border: #4C644B 1px solid">Register</button>
