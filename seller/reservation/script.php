...
function modalopenorderdet(product_id, reservation_id, customer_id) {
    $("#mdlopenorderdet").modal('show');

    $.ajax({
        type: 'POST',
        url: 'reservation/class.php',
        data: 'product_id=' + product_id + '&reservation_id=' + reservation_id + '&customer_id=' + customer_id +
...
function pendingapprove(reservation_id) {
    $(".preloader").show().css('background', 'rgba(255,255,255,0.5)');
    $.ajax({
        type: 'POST',
        url: 'reservation/class.php',
        data: 'reservation_id=' + reservation_id + '&form=pendingapprove',
        success: function(data) {
            setTimeout(function() {
...
function topayapprove(reservation_id, paymentstat) {
    if (paymentstat == "FORAPPROVAL") {
        ...
        $.ajax({
            type: 'POST',
            url: 'reservation/class.php',
            data: 'reservation_id=' + reservation_id + '&form=topayapprove',
            success: function(data) {
                setTimeout(function() {
                    $(".preloader").hide().css('background', '');
                    $("#mdlopenorderdet").modal('hide');
...
function toshipapprove(reservation_id) {
    $(".preloader").show().css('background', 'rgba(255,255,255,0.5)');
    ...
    $.ajax({
        type: 'POST',
        url: 'reservation/class.php',
        data: 'reservation_id=' + reservation_id + '&form=toshipapprove&courier=' + courier +
            '&trackingnumber=' +
            trackingnumber,
        success: function(data) {
            setTimeout(function() {
...
function todeliverapprove(reservation_id) {
    $(".preloader").show().css('background', 'rgba(255,255,255,0.5)');
    $.ajax({
        type: 'POST',
        url: 'reservation/class.php',
        data: 'reservation_id=' + reservation_id + '&form=todeliverapprove',
        success: function(data) {
            setTimeout(function() {
                $(".preloader").hide().css('background', '');
                $("#mdlopenorderdet").modal('hide');
