...
<option value="COMPLETED">Completed -->
                <div class="row">
                            ...
                            <div class="order-track">
                                <div class="order-track-step">
                                    ...
                                    <div class="order-track-text">
                                        <p
                                            class="order-track-text-stat order-track-text-statstatus order-track-text-stat1">
                                        </p>
                    ...
                    <div class="col-md-7">
                        ...
                        <button type='button' class='btn waves-effect waves-light btn-dark float-right readytodeliver'
                            disabled>READY TO DELIVER</button>
