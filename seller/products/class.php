...
switch ($_POST['form']) {
	...
	case 'displayproductlist':
		...
		$page = $_POST["page"];
		$limit = ($page - 1) * 10;
		$res = mysqli_query($connection, "SELECT a.product_id, a.productname, a.productdesc, a.price, a.quantity, a.unit, CASE WHEN b.middlename = '' OR b.middlename IS NULL THEN CONCAT(b.lastname, ', ', b.firstname) ELSE CONCAT(b.lastname, ', ', b.firstname, ' ', LEFT(b.middlename, '1'), '.') END, a.id FROM products AS a LEFT JOIN users_table AS b ON a.seller_id = b.user_id WHERE a.seller_id = '" . $_SESSION['user_id'] . "' " . $searchuseracc . " ORDER BY a.product_id ASC LIMIT " . $limit . ",10");
...
?> <option value="">- Select Category -</option>
	...
	case 'addproduct':
		...
		$addproduct = mysqli_query($connection, "INSERT INTO products SET product_id = '" . $generateID . "', seller_id = '" . $_SESSION['user_id'] . "', productname = '" . $_POST['textaddprodname'] . "', productdesc = '" . $_POST['textaddproddesc'] . "', price = '" . $_POST['textaddprodprice'] . "', quantity = '" . $_POST['textaddprodqty'] . "', unit = '" . $_POST['textaddprodunit'] . "', date_added = '" . date("Y-m-d") . "';");
	...
	case 'modaleditproduct':
		...
		$productdet = mysqli_fetch_array(mysqli_query($connection, "SELECT a.seller_id, CASE WHEN b.middlename = '' OR b.middlename IS NULL THEN CONCAT(b.lastname, ', ', b.firstname) ELSE CONCAT(b.lastname, ', ', b.firstname, ' ', LEFT(b.middlename, '1'), '.') END, a.productname, a.productdesc, a.quantity, a.unit, a.price FROM products AS a LEFT JOIN users_table AS b ON a.seller_id = b.user_id WHERE a.product_id = '" . $_POST['product_id'] . "';"));

		echo "|" . $productdet[0] . "|" . $productdet[1] . "|" . $productdet[2] . "|" . $productdet[3] . "|" . $productdet[4] . "|" . $productdet[5] . "|" . number_format($productdet[6], "2", ".", ",") . "|";
		...
		while ($row2 = mysqli_fetch_array($res2)) {
			...
			?> <option value="<?php echo $row2[0]; ?>"><?php echo $row2[1]; ?></option>
				...
				case 'editproduct':
					$editproduct = mysqli_query($connection, "UPDATE products SET seller_id = '" . $_SESSION['user_id'] . "', productname = '" . $_POST['textaddprodname'] . "', productdesc = '" . $_POST['textaddproddesc'] . "', price = '" . $_POST['textaddprodprice'] . "', quantity = '" . $_POST['textaddprodqty'] . "', unit = '" . $_POST['textaddprodunit'] . "' WHERE product_id = '" . $_POST['product_id'] . "';");
